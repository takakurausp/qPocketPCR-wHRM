...
このファirmwareは、アクセポイントモードに加えて**クライアントモード**にも対応しています。USBドライブ上の `WIFI.TXT` にSSIDとパスワードを記入しておくと、起動時にそのアクセポイントに接続できます（接続できればクライアントモード、できなければ従来どおりアクセポイントモード）。
...
> **⚠️ 日本の電波法に関する注意**
> 本ファirmwareのWiFi（アクセスポイント）機能は、日本の電波法の認証を受けていません。
